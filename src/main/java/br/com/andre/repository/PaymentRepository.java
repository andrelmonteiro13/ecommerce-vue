...
public interface PaymentRepository extends ReactiveCrudRepository<Payment, Long>, PaymentRepositoryInternal {
    ...
    @Override
    Mono<Payment> findOneWithEagerRelationships(Long id);

    @Override
    Flux<Payment> findAllWithEagerRelationships();

    @Override
    Flux<Payment> findAllWithEagerRelationships(Pageable page);
...
interface PaymentRepositoryInternal {
    ...
    Flux<Payment> findByCriteria(PaymentCriteria criteria, Pageable pageable);

    Mono<Long> countByCriteria(PaymentCriteria criteria);
