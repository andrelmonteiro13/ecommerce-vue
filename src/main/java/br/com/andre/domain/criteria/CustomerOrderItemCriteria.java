...
/**
 * Criteria class for the {@link br.com.andre.domain.CustomerOrderItem} entity. This class is used
 * in {@link br.com.andre.web.rest.CustomerOrderItemResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /customer-order-items?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CustomerOrderItemCriteria implements Serializable, Criteria {
    ...
    public CustomerOrderItemCriteria() {}

    public CustomerOrderItemCriteria(CustomerOrderItemCriteria other) {
    ...
    @Override
    public CustomerOrderItemCriteria copy() {
        return new CustomerOrderItemCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CustomerOrderItemCriteria that = (CustomerOrderItemCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, quantity, unitPrice, totalPrice, orderId, productId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "CustomerOrderItemCriteria{" +
