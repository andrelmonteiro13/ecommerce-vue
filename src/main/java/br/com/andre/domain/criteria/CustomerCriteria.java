...
/**
 * Criteria class for the {@link br.com.andre.domain.Customer} entity. This class is used
 * in {@link br.com.andre.web.rest.CustomerResource} to receive all the possible filtering options from
...
public class CustomerCriteria implements Serializable, Criteria {
    ...
    public CustomerCriteria(CustomerCriteria other) {
        ...
        this.document = other.optionalDocument().map(StringFilter::copy).orElse(null);
    ...
    public Optional<StringFilter> optionalDocument() {
        return Optional.ofNullable(document);
    }

    public StringFilter document() {
        if (document == null) {
            setDocument(new StringFilter());
        }
        return document;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, firstName, lastName, email, phone, document, createdDate, distinct);
    }
    ...
    public String toString() {
        return "CustomerCriteria{" +
            ...
            optionalDocument().map(f -> "document=" + f + ", ").orElse("") +
