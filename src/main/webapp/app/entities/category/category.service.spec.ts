...
describe('Service Tests', () => {
  describe('Category Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Category(123, 'AAAAAAA', 'AAAAAAA', false);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Category', async () => {
        const returnedFromService = { name: 'BBBBBB', description: 'BBBBBB', active: true, ...elemDefault };
      ...
      it('should partial update a Category', async () => {
        const patchObject = { description: 'BBBBBB', active: true, ...new Category() };
