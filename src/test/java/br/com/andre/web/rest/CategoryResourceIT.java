...
import static br.com.andre.domain.CategoryAsserts.*;
...
import br.com.andre.service.mapper.CategoryMapper;
...
class CategoryResourceIT {
    ...
    public static Category createEntity() {
        return new Category().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).active(DEFAULT_ACTIVE);
    }
    ...
    public static Category createUpdatedEntity() {
        return new Category().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).active(UPDATED_ACTIVE);
    }
