...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("br.com.andre.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("br.com.andre.security.DomainUserDetailsService", "createSpringSecurityUser");
